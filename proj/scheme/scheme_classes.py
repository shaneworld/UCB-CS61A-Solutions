...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        # make a new child frame
        child_frame = Frame(self)
        formal_list, val_list = formals, vals
        while formal_list is not nil:
            child_frame.bindings[formal_list.first] = val_list.first
            formal_list = formal_list.rest
            val_list = val_list.rest
        return child_frame
        # END PROBLEM 8
