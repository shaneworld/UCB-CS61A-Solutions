...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(num_rolls):
        ...
        if rs == 1:
            flag = True
        outcomes += rs
    return 1 if flag else outcomes
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    rs = 3 * abs(opponent_score // 10 % 10 - player_score % 10)
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    def fix_roll(player_score, opponent_score):
        return n
    return fix_roll
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    for player_score in range(goal):
        for opponent_score in range(goal):
            if strategy(player_score, opponent_score) != first:
                return False
    return True
    # END PROBLEM 7
