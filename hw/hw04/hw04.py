...
def balanced(m):
    ...
    if is_planet(m):
        ...
        torgue_left = length(left(m)) * total_mass(left_end) 
        torgue_right = length(right(m)) * total_mass(right_end) 
        return torgue_left == torgue_right and balanced(left_end) and balanced(right_end)
